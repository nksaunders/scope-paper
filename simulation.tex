...
\begin{center}
   ...
   \end{tabular}
	 \caption{Coefficients applied to the motion vectors of \textit{K2} target EPIC 205998445, an isolated C03 star. A coefficient of 1 corresponds to current motion, with each subsequent coefficient simply increasing the magnitude of motion by that factor. Motion is given in both pixels (pix) and arcseconds (arcsec).}
